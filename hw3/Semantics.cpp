...
//                 {
//                     Emit::Error::generic(lhsIdNode->getLineNum(), "Symbol \'" + lhsIdNode->getStringValue() + "\' is not declared.");
//                 }
//             }
...
//                 {
//                     Emit::Error::generic(rhsIdNode->getLineNum(), "Symbol \'" + rhsIdNode->getStringValue() + "\' is not declared.");
//                 }
//             }
...
// {
//     if (node == nullptr || node->getNodeKind() != Node::Kind::Exp || node->getExpKind() != Node::ExpKind::Id)
//     {
//         return false;
//     }
//     return true;
...
// {
//     if (node == nullptr || node->getNodeKind() != Node::Kind::Decl || node->getDeclKind() != Node::DeclKind::Func)
//     {
//         return false;
//     }
//     return true;
...
bool Semantics::isValidMainFunc(Func *funcNode) const
{
    ...
    // if (funcNode->getDataType() != Data::Type::Void)
    // {
    //     return false;
    // }
